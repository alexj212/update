# go-update: Build self-updating Go programs [![godoc reference](https://godoc.org/github.com/alexj212/update?status.png)](https://godoc.org/github.com/alexj212/update)
